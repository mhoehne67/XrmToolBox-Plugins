...
{	
	...
	{		
		...
		internal mho.PluginStepsViewer.EarlyBoundTypes.PluginType plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<mho.PluginStepsViewer.EarlyBoundTypes.PluginType>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
		...
		internal mho.PluginStepsViewer.EarlyBoundTypes.PluginType plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<mho.PluginStepsViewer.EarlyBoundTypes.PluginType>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
