...
namespace mho.PluginStepsViewer.EarlyBoundTypes
{
	...
	internal partial class PluginAssembly : Microsoft.Xrm.Sdk.Entity
	{
		/// <summary>
		...
		public System.Collections.Generic.IEnumerable<mho.PluginStepsViewer.EarlyBoundTypes.PluginType> pluginassembly_plugintype
		{
			get
			{
				return this.GetRelatedEntities<mho.PluginStepsViewer.EarlyBoundTypes.PluginType>("pluginassembly_plugintype", null);
			}
			set
			{
				this.SetRelatedEntities<mho.PluginStepsViewer.EarlyBoundTypes.PluginType>("pluginassembly_plugintype", null, value);
			}
		}
	}
}
